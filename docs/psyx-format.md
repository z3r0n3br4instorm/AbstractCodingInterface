...
Use `IMPORT-BLK-START` to define explicit libraries or dependencies your code needs. The compiler will also automatically extract any imports generated by other blocks and merge them into the global imports section at the top of the file, even if you don't explicitly define this block.
